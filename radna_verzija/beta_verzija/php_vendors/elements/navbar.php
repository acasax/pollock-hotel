          ...
          <div class="milenia-aligner-inner">
            ...
            <div class="milenia-header-section-md milenia-header-section--sticky-hidden milenia-header-section--border milenia-header-section--font-small">
              ...
              <div class="milenia-header-col milenia-header-col-md-7 milenia-aligner milenia-header-col--content-align-left-md milenia-header-col--padding-small">
                <div class="milenia-aligner-outer">
                  <div class="milenia-aligner-inner align-items-center" style="display: flex;">
                    <div class="milenia-header-items">
                      <div>
                        ...
                        <nav class="milenia-navigation-container">
                          <ul class="milenia-navigation milenia-navigation--vertical-sm">
                            ...
                            <li class="menu-item menu-item-has-children"><a href="rooms.php" class="milenia-ln--independent">Sobe</a>
                              <!--================ Sub Menu ================-->
                              <ul class="sub-menu">
                                <li class="menu-item"><a href="rooms_single_room_page_v1.html" class="milenia-ln--independent">Klasićna dvokrevetna soba</a>
                                </li>
                                <li class="menu-item"><a href="rooms_single_room_page_v2.html" class="milenia-ln--independent">Porodična četvorokrevetna soba</a>
                                </li>
                                <li class="menu-item"><a href="rooms_single_room_page_v2.html" class="milenia-ln--independent">Apartman za četri pspbe</a>
                                </li>
                              </ul>
                              <!--================ End of Sub Menu ================-->
                            </li>
                            ...
                            <li class="menu-item menu-item-has-children"><a href="pages_contact_v1.html" class="milenia-ln--independent">Kontakt</a></li>
                          </ul>
                        </nav>
