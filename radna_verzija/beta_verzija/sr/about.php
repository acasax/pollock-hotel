    ...
    <div class="container">
      ...
      <section class="milenia-section milenia-section--stretched milenia-colorizer--scheme-lightest">
        <div class="row align-items-center">
          <div class="col-lg-6">
            <h2 class="milenia-section-title milenia-section-title--style-2">Činimo obično, izvanrednim.</h2>
      ...
      <div class="milenia-section milenia-section--stretched-content-no-px milenia-section--no-py">
        <!--================ Entities (Style 3) ================-->
        <div class="milenia-entities milenia-entities--style-3 milenia-entities--filled milenia-entities--title-reduced">
      ...
      <div class="milenia-section">
        <!--================ Entities (Style 5) ================-->
        <div class="milenia-entities milenia-entities--style-5">
