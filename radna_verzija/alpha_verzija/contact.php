          ...
          <div class="milenia-section">
            <div class="row">
              ...
              <aside class="col log-8">
                <h3>Voleli bismo da čujemo od vas!</h3>
