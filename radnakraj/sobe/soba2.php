...
<head>
  ...
  <!--================ Basic page needs ================-->
  <title>Pollockhotel / Deluxe Family Room</title>
  <meta charset="UTF-8">
...
<body class="milenia-body--scheme-lightbrown">
  <?php include "../php_vendors/elements/navbarroom.php" ?>
  <!--================ End of Header ================-->
  <!--================ Slider Revolution ================-->
      ...
      <div class="container">
        <div class="milenia-page-header">
          <div class="row align-items-center milenia-columns-aligner--edges-lg">
            <div class="col-lg-9">
              <h1 class="milenia-page-title">Deluxe Family Room</h1>
            </div>
            <div class="col-lg-3">
            ...
            <div class="row">
              <div class="col-md-4">
                <ul class="milenia-list--unstyled milenia-list--icon milenia-list--icon-big">
                  <li>Double bed<i class="milenia-font-icon-double-bed"></i></li>
                  <li>Balcony<i class="milenia-font-icon-table-chairs-umbrella"></i></li>
                  ...
                  <li>Hairdryer<i class="milenia-font-icon-hair-dryer"></i></li>
                  <li>Slippers<i class="milenia-font-icon-flip-flops"></i></li>
              ...
              <div class="col-md-4">
                <ul class="milenia-list--unstyled milenia-list--icon milenia-list--icon-big">
                  <li>Safe<i class="milenia-font-icon-safe"></i></li>
                  <li>Free private parking<i class="milenia-font-icon-parking2"></i></li>
