                ...
                <section class="milenia-grid-item milenia-widget milenia-widget--newsletter">
                  <div class="milenia-grid-item-inner">
                    <div class="milenia-grid-item-content">
                      ...
                      <form class="milenia-singlefield-form milenia-newsletter-form" id="subscription_sr">
                  ...
                  <div class="milenia-grid-item-inner">
                    <div class="milenia-grid-item-content">
                      ...
                      <ul class="milenia-details-list milenia-list--unstyled">
                        ...
                        <li><span class="milenia-text-color--contrast">Telefon:&nbsp;</span><a href="tel: 037-865-125"> 037/ 865-125</a></li>
                    ...
                    <div class="milenia-grid-item-content">
                      ...
                      <nav>
                        <ul>
                          ...
                          <li><a href="sr/additional_content.php">Conferential room</a></li>
                        </ul>
                      </nav>
                    </div>
                  </div>
          ...
          <div class="container">
            <div class="milenia-footer-row--inner milenia-footer-row-inner--no-offsets">
              <div class="milenia-grid milenia-grid--cols-1">
                <div class="milenia-grid-item milenia-widget milenia-widget--center-aligned">Copyright © 2021 Pollockhotel. All Rights Reserved. Designed by <a href="www.resivoje.com">RešivoJe</a></div>
              </div>
            </div>
          </div>
        </div>
