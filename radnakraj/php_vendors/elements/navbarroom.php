                        ...
                        <nav class="milenia-navigation-container">
                          <ul class="milenia-navigation milenia-navigation--vertical-sm">
                            ...
                            <li class="menu-item menu-item-has-children"><a href="../rooms.php" class="milenia-ln--independent">Rooms</a>
                              <!--================ Sub Menu ================-->
                              <ul class="sub-menu">
                                <li class="menu-item"><a href="soba1.php" class="milenia-ln--independent">Deluxe Double Room</a>
                                </li>
                                <li class="menu-item"><a href="soba2.php" class="milenia-ln--independent">Deluxe Family Room</a>
                                </li>
                                <li class="menu-item"><a href="soba3.php" class="milenia-ln--independent">Deluxe Suite</a>
                                </li>
                              </ul>
                              <!--================ End of Sub Menu ================-->
                            </li>
